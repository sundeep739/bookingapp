...
export default function LoginButton() {
  ...
  const sendMagicLink = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res?.error) setError("Couldn't send the link. Please try again.");
      else setSent(true);
    } catch {
  ...
  return (
    <div className="space-y-4">
      <button
        ...
        className="w-full flex items-center justify-center gap-3 py-3.5 px-6 bg-white border-2 border-gray-200 rounded-2xl text-sm font-semibold text-gray-700 hover:border-gray-300 hover:bg-gray-50 transition-all shadow-sm"
      >
