...
export default function DashboardHeader() {
  ...
  return (
    <div className="px-4 md:px-8 pt-6 pb-2">
      <div className="rounded-2xl p-6 md:p-7 relative overflow-hidden" style={{ background: "linear-gradient(135deg,#1E1B4B 0%,#4338CA 100%)" }}>
        {/* decorative blob */}
        <div className="absolute top-0 right-0 w-64 h-64 rounded-full opacity-10"
          style={{ background: "radial-gradient(circle,#4F46E5,transparent)", transform: "translate(30%,-40%)" }} />
        ...
        <div className="relative flex flex-col md:flex-row md:items-center md:justify-between gap-5">
          <div className="flex items-center gap-4 pl-10 lg:pl-0">
            {session?.user?.image ? (
              ...
              <div className="w-[52px] h-[52px] rounded-2xl bg-indigo-500 flex items-center justify-center text-white text-xl font-bold flex-shrink-0">
                {firstName[0]}
              </div>
            )}
            <div>
